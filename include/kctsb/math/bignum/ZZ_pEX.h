...
#ifndef KCTSB_ZZ_pEX__H
#define KCTSB_ZZ_pEX__H
...
KCTSB_DECLARE_RELOCATABLE((ZZ_pEX*))


KCTSB_SNS istream& operator>>(KCTSB_SNS istream& s, ZZ_pEX& x);
KCTSB_SNS ostream& operator<<(KCTSB_SNS ostream& s, const ZZ_pEX& a);
...
inline ZZ_pEX random_ZZ_pEX(long n)
   { ZZ_pEX x; random(x, n); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX diff(const ZZ_pEX& a)
   { ZZ_pEX x; diff(x, a);  KCTSB_OPT_RETURN(ZZ_pEX, x); }
// x = derivative of a
...
inline ZZ_pEX reverse(const ZZ_pEX& a, long hi)
   { ZZ_pEX x; reverse(x, a, hi); KCTSB_OPT_RETURN(ZZ_pEX, x); }

inline void reverse(ZZ_pEX& c, const ZZ_pEX& a)
{  reverse(c, a, deg(a)); }

inline ZZ_pEX reverse(const ZZ_pEX& a)
   { ZZ_pEX x; reverse(x, a); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX to_ZZ_pEX(long a)
   { ZZ_pEX x; conv(x, a); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX operator+(const ZZ_pEX& a, const ZZ_pEX& b)
   { ZZ_pEX x; add(x, a, b); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX operator-(const ZZ_pEX& a, const ZZ_pEX& b)
   { ZZ_pEX x; sub(x, a, b); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX operator-(const ZZ_pEX& a) 
   { ZZ_pEX x; negate(x, a); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX sqr(const ZZ_pEX& a) 
   { ZZ_pEX x; sqr(x, a); KCTSB_OPT_RETURN(ZZ_pEX, x); }
// x = a^2
...
inline ZZ_pEX MulTrunc(const ZZ_pEX& a, const ZZ_pEX& b, long n)
   { ZZ_pEX x; MulTrunc(x, a, b, n); KCTSB_OPT_RETURN(ZZ_pEX, x); }
// x = a * b % X^n

void SqrTrunc(ZZ_pEX& x, const ZZ_pEX& a, long n);
inline ZZ_pEX SqrTrunc(const ZZ_pEX& a, long n)
   { ZZ_pEX x; SqrTrunc(x, a, n); KCTSB_OPT_RETURN(ZZ_pEX, x); }
// x = a*a % X^n


inline ZZ_pEX operator*(const ZZ_pEX& a, const ZZ_pEX& b)
   { ZZ_pEX x; mul(x, a, b); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX power(const ZZ_pEX& a, long e)
   { ZZ_pEX x; power(x, a, e); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX InvTrunc(const ZZ_pEX& a, long m)
   { ZZ_pEX x; InvTrunc(x, a, m); KCTSB_OPT_RETURN(ZZ_pEX, x); }
// computes x = a^{-1} % X^m 
// constant term must be invertible


inline ZZ_pEX operator/(const ZZ_pEX& a, const ZZ_pEX& b)
   { ZZ_pEX x; div(x, a, b); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX operator%(const ZZ_pEX& a, const ZZ_pEX& b)
   { ZZ_pEX x; rem(x, a, b); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX GCD(const ZZ_pEX& a, const ZZ_pEX& b)
   { ZZ_pEX x; GCD(x, a, b); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
KCTSB_DECLARE_RELOCATABLE((ZZ_pEXModulus*))
...
inline ZZ_pEX PowerMod(const ZZ_pEX& g, const ZZ& e, 
                             const ZZ_pEXModulus& F)
   { ZZ_pEX x; PowerMod(x, g, e, F);  KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX PowerXMod(const ZZ& e, const ZZ_pEXModulus& F)
   { ZZ_pEX x; PowerXMod(x, e, F);  KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX operator%(const ZZ_pEX& a, const ZZ_pEXModulus& F)
   { ZZ_pEX x; rem(x, a, F); KCTSB_OPT_RETURN(ZZ_pEX, x); }

inline ZZ_pEX& operator%=(ZZ_pEX& x, const ZZ_pEXModulus& F)
   { rem(x, x, F); return x; }

inline ZZ_pEX operator/(const ZZ_pEX& a, const ZZ_pEXModulus& F)
   { ZZ_pEX x; div(x, a, F); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX BuildFromRoots(const vec_ZZ_pE& a)
   { ZZ_pEX x; BuildFromRoots(x, a); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX interpolate(const vec_ZZ_pE& a, const vec_ZZ_pE& b)
   { ZZ_pEX x; interpolate(x, a, b); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
CompMod(const ZZ_pEX& g, const ZZ_pEX& h, const ZZ_pEXModulus& F)
   { ZZ_pEX x; CompMod(x, g, h, F); KCTSB_OPT_RETURN(ZZ_pEX, x); }
// x = g(h) mod f
...
extern KCTSB_CHEAP_THREAD_LOCAL long ZZ_pEXArgBound;
...
inline ZZ_pEX MinPolySeq(const vec_ZZ_pE& a, long m)
   { ZZ_pEX x; MinPolySeq(x, a, m); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX MinPolyMod(const ZZ_pEX& g, const ZZ_pEXModulus& F)
   { ZZ_pEX x; MinPolyMod(x, g, F); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX MinPolyMod(const ZZ_pEX& g, const ZZ_pEXModulus& F, long m)
   { ZZ_pEX x; MinPolyMod(x, g, F, m); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX ProbMinPolyMod(const ZZ_pEX& g, const ZZ_pEXModulus& F)
   { ZZ_pEX x; ProbMinPolyMod(x, g, F); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX ProbMinPolyMod(const ZZ_pEX& g, const ZZ_pEXModulus& F, long m)
   { ZZ_pEX x; ProbMinPolyMod(x, g, F, m); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX IrredPolyMod(const ZZ_pEX& g, const ZZ_pEXModulus& F)
   { ZZ_pEX x; IrredPolyMod(x, g, F); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX IrredPolyMod(const ZZ_pEX& g, const ZZ_pEXModulus& F, long m)
   { ZZ_pEX x; IrredPolyMod(x, g, F, m); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline vec_ZZ_pE UpdateMap(const vec_ZZ_pE& a,
         const ZZ_pEXTransMultiplier& B, const ZZ_pEXModulus& F)
   { vec_ZZ_pE x; UpdateMap(x, a, B, F); KCTSB_OPT_RETURN(vec_ZZ_pE, x); }
...
inline vec_ZZ_pE ProjectPowers(const vec_ZZ_pE& a, long k, 
                   const ZZ_pEXArgument& H, const ZZ_pEXModulus& F)
   { vec_ZZ_pE x; ProjectPowers(x, a, k, H, F); KCTSB_OPT_RETURN(vec_ZZ_pE, x); }
...
inline ZZ_pE project(const vec_ZZ_pE& a, const ZZ_pEX& b)
   { ZZ_pE x; InnerProduct(x, a, b.rep); KCTSB_OPT_RETURN(ZZ_pE, x); }
...
inline ZZ_pEX CompTower(const ZZ_pX& g, const ZZ_pEXArgument& A,
             const ZZ_pEXModulus& F)
   { ZZ_pEX x; CompTower(x, g, A, F); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pEX CompTower(const ZZ_pX& g, const ZZ_pEX& h,
             const ZZ_pEXModulus& F)
   { ZZ_pEX x; CompTower(x, g, h, F); KCTSB_OPT_RETURN(ZZ_pEX, x); }
...
inline ZZ_pX ProbMinPolyTower(const ZZ_pEX& g, const ZZ_pEXModulus& F,
                      long m)
   { ZZ_pX x; ProbMinPolyTower(x, g, F, m); KCTSB_OPT_RETURN(ZZ_pX, x); }
...
inline ZZ_pX ProbMinPolyTower(const ZZ_pEX& g, const ZZ_pEXModulus& F)
   { ZZ_pX x; ProbMinPolyTower(x, g, F); KCTSB_OPT_RETURN(ZZ_pX, x); }
...
inline ZZ_pX MinPolyTower(const ZZ_pEX& g, const ZZ_pEXModulus& F,
                      long m)
   { ZZ_pX x; MinPolyTower(x, g, F, m); KCTSB_OPT_RETURN(ZZ_pX, x); }
...
inline ZZ_pX MinPolyTower(const ZZ_pEX& g, const ZZ_pEXModulus& F)
   { ZZ_pX x; MinPolyTower(x, g, F); KCTSB_OPT_RETURN(ZZ_pX, x); }
...
inline ZZ_pX IrredPolyTower(const ZZ_pEX& g, const ZZ_pEXModulus& F,
                      long m)
   { ZZ_pX x; IrredPolyTower(x, g, F, m); KCTSB_OPT_RETURN(ZZ_pX, x); }
...
inline ZZ_pX IrredPolyTower(const ZZ_pEX& g, const ZZ_pEXModulus& F)
   { ZZ_pX x; IrredPolyTower(x, g, F); KCTSB_OPT_RETURN(ZZ_pX, x); }
