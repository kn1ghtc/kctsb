...
void swap(RR& z) { x.swap(z.x); _kctsb_swap(e, z.e); }
...
inline RR abs(const RR& a)
   { RR z; abs(z, a); KCTSB_OPT_RETURN(RR, z); }
...
inline RR sqr(const RR& a)
   { RR z; sqr(z, a); KCTSB_OPT_RETURN(RR, z); }
...
inline RR inv(const RR& a)
   { RR z; inv(z, a); KCTSB_OPT_RETURN(RR, z); }

// operator notation:

inline RR operator+(const RR& a, const RR& b)
   { RR x; add(x, a, b); KCTSB_OPT_RETURN(RR, x); }
...
inline RR operator-(const RR& a, const RR& b)
   { RR x; sub(x, a, b); KCTSB_OPT_RETURN(RR, x); }
...
inline RR operator*(const RR& a, const RR& b)
   { RR x; mul(x, a, b); KCTSB_OPT_RETURN(RR, x); }
...
inline RR operator/(const RR& a, const RR& b)
   { RR x; div(x, a, b); KCTSB_OPT_RETURN(RR, x); }
...
inline RR operator-(const RR& a)
   { RR x; negate(x, a); KCTSB_OPT_RETURN(RR, x); }
...
inline RR ConvPrec(const char *s, long p)
   { RR z; ConvPrec(z, s, p); KCTSB_OPT_RETURN(RR, z); }

KCTSB_SNS istream& InputPrec(RR& z, KCTSB_SNS istream& s, long p);
inline RR InputPrec(KCTSB_SNS istream& s, long p)
   { RR z; KCTSB_INPUT_CHECK_ERR(InputPrec(z, s, p)); KCTSB_OPT_RETURN(RR, z); }

void MakeRRPrec(RR& z, const ZZ& a, long e, long p);
inline RR MakeRRPrec(const ZZ& a, long e, long p)
   { RR z; MakeRRPrec(z, a, e, p); KCTSB_OPT_RETURN(RR, z); }
