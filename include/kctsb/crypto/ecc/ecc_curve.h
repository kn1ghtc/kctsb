...
private:
     ...
     * This is the ONLY scalar multiplication method used.
     * 
     * NOTE: wNAF algorithm was removed due to side-channel vulnerabilities.
     * Montgomery ladder provides timing-attack resistance.
     */
