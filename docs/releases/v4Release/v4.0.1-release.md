...
- For 256-bit SM2 curve parameters: 4 limbs × 4 lost bits = ~12 bits lost (256 → 244 bits)
...
- ✅ SM2 (10 tests) - Sign/Verify/Encrypt/Decrypt
- ✅ RSA (21 tests) - Key generation/Sign/Verify/Encrypt/Decrypt
- ✅ ECC (15 tests) - Curve operations
- ✅ AES/ChaCha20/Poly1305 (48 tests)
- ✅ Math/BigNum (38 tests) - ZZ/GF2X operations
