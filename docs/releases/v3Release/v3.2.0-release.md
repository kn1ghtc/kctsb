...
├── advanced/
│   ├── pqc/
│   │   └── pqc.h          # Kyber, Dilithium
│   ├── zk/
│   │   └── zkp.h          # Groth16 zk-SNARKs
│   ├── fe/                # Functional Encryption
│   ├── sss/               # Shamir Secret Sharing
│   └── whitebox/          # Whitebox AES
├── crypto/
│   ├── ecc/               # ECC (ECDSA, ECDH, ECIES)
│   ├── rsa/               # RSA, DH, DSA
│   ├── hash/              # SHA3, BLAKE2, etc.
│   └── sm/                # Chinese standards
└── simd/
    └── simd.h             # SIMD acceleration
...
│   └── zk/zkp.cpp
├── crypto/
│   ├── ecc/               # 4 implementation files
│   └── rsa/               # 3 implementation files
└── simd/simd.cpp
```
...
| ECDSA Sign (P-256) | 45 µs | 42 µs | 0.93x |
| Kyber768 Keygen | 28 µs | N/A | - |
| Kyber768 Encaps | 35 µs | N/A | - |
| Dilithium3 Sign | 180 µs | N/A | - |
