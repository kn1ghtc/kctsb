...
```
新增文件:
  include/kctsb/advanced/fe/common/ntt.hpp     # NTT 公共接口
  src/advanced/fe/common/ntt.cpp               # NTT 实现
  tests/unit/fhe/test_ntt.cpp                  # NTT 测试 (21 tests)
