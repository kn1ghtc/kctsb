...
- **θ step**: Parallel column parity computation
- **ρ/π steps**: Correct rotation offsets per FIPS 202
- **χ step**: Row-wise non-linear transformation
...
2. **Keccak AVX2**: Corrected ρ step rotation offsets for FIPS 202 compliance
