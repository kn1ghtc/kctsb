...
TEST(SHA256Test, EmptyString) {
    ...
    uint8_t digest[32];
    kctsb_sha256(reinterpret_cast<const uint8_t*>(""), 0, digest);
...
TEST(SHA256Test, ABC) {
    ...
    uint8_t digest[32];
    kctsb_sha256(reinterpret_cast<const uint8_t*>("abc"), 3, digest);
...
TEST(SHA256Test, IncrementalUpdate) {
    ...
    kctsb_sha256_update(&ctx, reinterpret_cast<const uint8_t*>("ab"), 2);
    kctsb_sha256_update(&ctx, reinterpret_cast<const uint8_t*>("c"), 1);
...
TEST(SHA512Test, EmptyString) {
    // SHA-512("")
    uint8_t digest[64];
    kctsb_sha512(reinterpret_cast<const uint8_t*>(""), 0, digest);
...
TEST(SHA512Test, ABC) {
    // SHA-512("abc")
    uint8_t digest[64];
    kctsb_sha512(reinterpret_cast<const uint8_t*>("abc"), 3, digest);
...
TEST(SHA512Test, LongMessage) {
    ...
    uint8_t digest[64];
    kctsb_sha512(reinterpret_cast<const uint8_t*>(msg), strlen(msg), digest);
...
TEST(SHA512Test, IncrementalUpdate) {
    ...
    kctsb_sha512_update(&ctx, reinterpret_cast<const uint8_t*>("ab"), 2);
    kctsb_sha512_update(&ctx, reinterpret_cast<const uint8_t*>("c"), 1);
...
TEST(SHATest, DifferentOutputSizes) {
    ...
    kctsb_sha256(reinterpret_cast<const uint8_t*>(msg), strlen(msg), sha256);
    kctsb_sha512(reinterpret_cast<const uint8_t*>(msg), strlen(msg), sha512);
