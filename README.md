...
> **v4.2.0 更新** (2026年1月):  
> - 🔐 **原生BGV全同态加密**: 基于kctsb bignum实现的BGV方案框架（开发中）
> - ⚡ **ECC wNAF优化**: 使用w=5窗口非相邻表示法，标量乘法~3.5x加速
> - 🔧 **GLV分解**: secp256k1曲线自同态优化
> - 🔧 **常量时间操作修复**: ct_select/ct_negate使用字节级掩码操作，防止侧信道攻击
> - 📊 **Benchmark格式统一**: SM2/SM4 benchmark输出与RSA/ECC格式一致，显示ratio对比
> - ✅ **测试全通过**: SM2 全部10个测试用例通过
