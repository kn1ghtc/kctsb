 ...
 * - 4-limb representation (4 脳 64-bit) for optimal SIMD
 ...
 * 
 * Uses the property: 2^256 鈮?2^32 + 977 (mod p)
 * 
...
/**
 * @brief Full 256脳256 鈫?512 bit multiplication
...
/**
 * @brief Full 256-bit squaring 鈫?512 bit result
 * @param r Result (512-bit)
 * @param a Operand
 */
