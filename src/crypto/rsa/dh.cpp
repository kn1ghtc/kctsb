...
DHParams get_modp_2048() {
    ...
    // RFC 3526 Group 14
    params.p = ZZ::from_decimal("");
...
DHParams get_modp_3072() {
    ...
    // RFC 3526 Group 15
    params.p = ZZ::from_decimal("");
...
DHParams get_modp_4096() {
    ...
    // RFC 3526 Group 16
    params.p = ZZ::from_decimal("");
